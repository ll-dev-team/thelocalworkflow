...
function transcode(folderPath, crfVal){
...
function createProxy(filePath){
  ...
  // // var filePath = path.join(sourcePath, fileNameExt);
  // if (!(/\.(mov|mp4|mts)$/i).test(fileNameExt)){
  //   console.log(fileNameExt + " is not a movie file");
  //   // cb();
  // }
  // else {
