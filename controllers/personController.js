...
exports.person_detail = function(req, res, next) {
  ...
  // res.send("coming from person_detail")
  ...
  //   });
    ...
    async.parallel({
        person: function(callback) {
            ...
            // Successful, so render
            console.log("\n\n+++++++++++++++++++++\n\nGetting a person.\n");
            console.log(JSON.stringify(results.person, null, 4));
            console.log("\n\n+++++++++++++++++++++\n\n\n");
            res.render('database/person_detail', { title: 'Person Detail', tabTitle: 'Person Detail', thePerson: results.person})
